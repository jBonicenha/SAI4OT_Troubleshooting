...
import { Diagram, mapEqpDetailsToDiagrams } from './diagram-generator.component';
...
export class DiagramGeneratorComponent implements OnInit {
    ...
    //TEMP FUNCTION to read XML file
    ...
    async generateNetworkDiagram() {
        try {
            ...
            this.diagramXMLresult = await this.readXmlFile('assets/NetworkDiagramExample.xml');
